...
const normalUsers = ["Azizbek", "Abrorbek", "Umarbek", "Abdurahmon", "Sherzodbek", "Saidalixon", "Mexriddin", "Ortiqjon", "Dostonbek", "Husanboy", "Javharbek", "Humoyun", "Muhiddin", "Artur", "Mirjaxon", "Golibjon", "Oybek", "Hajarbibi", "Bonu", "Sabina", "Charos"];
